<template>
  <v-sheet xs12 md12 lg12 class="my-2 mt-0">        
    <v-row class="totalHt">
      <v-col class="justify-center" xl="2" lg="2" md="auto" sm="auto" color="grey-lighten-3" >
        ...
        <v-col class="justify-center mt-n1 pr-0 pl-0" style="padding:0px;" align="right" xl="2" lg="2" md="auto" sm="auto" color="grey" v-if="showDomainPanel == 0" >
          <div class="totalHt columnTopLeft" style="padding-top:6px;padding-left:20px;padding-right:12px;padding-bottom:4px;">  
        ...
        <v-col class="justify-center mt-n1 pr-0 pl-0" style="padding:0px;" align="right" xl="2" lg="2" md="auto" sm="auto" color="grey" v-if="showDomainPanel == 1">
          <div class="topRow columnTopLeft" align="right" style="padding-left:20px;padding-right:12px;padding-bottom:4px;">  
        ...
        <v-col style="padding:0px;" xl="4" lg="4" md="6" sm="6" color="grey">
          <div >
        ...
        <v-col class="justify-center mt-n1 pr-0 pl-0" style="padding:0px;" align="left" xl="2" lg="2" md="auto" sm="auto" color="grey" v-if="showLinksPanel == 0">
          <div class="totalHt columnTopRight" style="padding-top:2px;padding-left:10px;padding-right:20px;padding-bottom:4px;">  
        ...
        <v-col style="padding:0px;" align="right" xl="2" lg="2" md="auto" sm="auto" color="grey"v-if="showLinksPanel == 1">
          <div class="topRow columnTopRight" align="left" style="padding-top:2px;padding-left:0px;padding-right:20px;padding-bottom:2px;">  
            <span STYLE="font-size:22.0pt;font-family:arial; color: white;">-</span>
  ...
  //<recentLinks />
    ...
    export default {
      ...
      async mounted () {
        ...
        */
        this.$bus.$on('xACTIVATE_TITLE_HOME', (data) => {
          document.title = 'Home'
        console.log('new title: Home')
      })

        this.$bus.$on('ACTIVATE_HOME', (data) => {
          //this.sUID = this.gdata.sUID;
          //this.loginStatus = 1;
          //dload.loadHomeDomain( gdata.sDomain, gdata.axios, gdata, gdata.homeData,2)
          console.log('ACTIVATE_LOGIN: ' + this.gdata.sDomainDescription)
        ...
        await dload.loadHomeDomain( this.gdata.sDomain, this.gdata.axios, this.gdata, this.gdata.homeData,2)
        ...
        //if(dload.getLocation() == 'home'){document.title = 'Home'}
        this.componentKey+=1;
      },    
