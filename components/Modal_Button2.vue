<template>
   <div align="right" style="width: 42%; height: 5vh;background-color: white;padding-top:6px;" >  
      ...
      <v-btn v-if="xLocation !='index'" density="comfortable" rounded="sm" color="iconic" variant="outlined" icon="mdi-domain" nuxt to="/"><v-icon color="iconic">mdi-domain</v-icon><v-tooltip class="sitesdesc" activator="parent" location="bottom">Explore Domains</v-tooltip></v-btn>
      ...
      <v-btn v-if="xLocation !='home' && xLoginStatus == 1" density="comfortable" rounded="sm" color="iconic" variant="outlined" icon="mdi-home" nuxt to="/home"><v-icon color="iconic">mdi-home</v-icon><v-tooltip class="sitesdesc" activator="parent" location="bottom">Home Domain</v-tooltip></v-btn>
      <span STYLE="font-size:22.0pt;font-family:arial; color: white;">-</span>
      <edit v-if="xLocation =='local'" />  
      <v-btn v-if="xLocation !='local'" density="comfortable" rounded="sm" color="iconic" variant="outlined" icon="mdi-desktop-classic" nuxt to="/local" ><v-icon color="iconic">mdi-desktop-classic</v-icon><v-tooltip class="sitesdesc" activator="parent" location="bottom">Local Desktop</v-tooltip></v-btn>
      <span STYLE="font-size:22.0pt;font-family:arial; color: white;">-</span>
    </div>    
