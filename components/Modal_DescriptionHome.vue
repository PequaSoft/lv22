<template>
  <v-col >
    <v-row >
    <div align="left" style="width: 100%; height: 5vh;padding-top:4px;background-color: white;" >  
      <span STYLE="font-size:14.0pt;font-family:arial; color: grey;">{{ xDomainDesc }}</span>
    </div>    
  ...
  export default {
    ...
    xDomainDesc() {
      ...
      if(this.gdata.sDomainDescription != undefined || this.gdata.sDomainDescription != null) {res=this.gdata.sDomainDescription;}
