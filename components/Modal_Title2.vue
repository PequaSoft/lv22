<template>
  <v-col >
    <v-row >
    <div align="left" style="width: 50%; height: 5vh;padding-left:4px;padding-top:12px;background-color: white;" >  
      <span STYLE="font-size:18.0pt;font-family:arial; color: grey;">{{ xCurrDomain }}</span>
    </div>    
    <buttonModal2 v-if="xDevice =='desktop'" />
    <buttonModalMini v-if="xDevice !='desktop'" />    
</v-row>
  ...
  import buttonModal2 from '~/components/Modal_Button2.vue'
  import buttonModalMini from '~/components/Modal_ButtonMini.vue'
