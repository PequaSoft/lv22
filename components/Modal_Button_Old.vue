<template>
  ...
  <v-btn density="comfortable" rounded="sm" color="iconic" variant="outlined" icon="mdi-magnify" nuxt to="/home"><v-icon color="iconic">mdi-home</v-icon><v-tooltip class="sitesdesc" activator="parent" location="start">Home Domain</v-tooltip></v-btn>
  <span STYLE="font-size:22.0pt;font-family:arial; color: white;">-</span>
  <v-btn density="comfortable" rounded="sm" color="iconic" variant="outlined" icon="mdi-magnify"><v-icon color="iconic">mdi-bookmark</v-icon><v-tooltip class="sitesdesc" activator="parent" location="end">Local Domain</v-tooltip></v-btn>
