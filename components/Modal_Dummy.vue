...
<v-dialog max-width="500">
      <template v-slot:activator="{ props: activatorProps }">
        <v-btn density="comfortable" v-bind="activatorProps" rounded="sm" color="warning" variant="outlined" @click="clickSearch" icon="mdi-magnify"><v-icon color="iconic">mdi-magnify</v-icon><v-tooltip class="sitesdesc" activator="parent" location="start">Search Bookmark Domains</v-tooltip></v-btn>    
      </template>
